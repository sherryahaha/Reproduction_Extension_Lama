...
cat fetch_data/train_shuffled.flist | tr "\r\n" "\n" | shuf > celeba-hq-dataset/temp_train_shuffled.flist
...
cat fetch_data/val_shuffled.flist | tr "\r\n" "\n" > celeba-hq-dataset/visual_test_shuffled.flist
...
echo "out_root_dir: /content/drive/MyDrive/experiments/" >> $CELEBA
echo "tb_dir: /content/drive/MyDrive/tb_logs/" >> $CELEBA
